    ...
    return (
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                {activity.isHost ? (
                    <>
                    <Button onClick={cancelActivityToggle} loading={loading} basic color={activity.isCancelled ? 'green' : 'red'} content= {activity.isCancelled ? 'Re-activate Activity' : "Cancel Activity"} />
