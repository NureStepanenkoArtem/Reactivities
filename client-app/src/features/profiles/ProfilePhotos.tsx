...
export default observer(function ProfilePhotos({profile}: Props) {
    ...
    function handleSetMainPhoto(photo: Photo, e: React.SyntheticEvent<HTMLButtonElement>){
        setTarget(e.currentTarget.name);
        setMainPhoto(photo);
    }

    function handleDeletePhoto(photo: Photo, e: React.SyntheticEvent<HTMLButtonElement>){
        setTarget(e.currentTarget.name);
        deletePhoto(photo);
    }
